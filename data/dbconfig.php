...
define('G5_MYSQL_USER', 'IMAGERY');
define('G5_MYSQL_PASSWORD', 'geolabs778800');
define('G5_MYSQL_DB', 'kysimagery');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'IMG_');

define('G5_TOKEN_ENCRYPTION_KEY', '058263e700cb92863c0083ba84e3e2f3'); // 토큰 암호화에 사용할 키
